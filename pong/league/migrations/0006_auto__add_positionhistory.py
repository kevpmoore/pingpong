...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'league_positionhistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('league_player_fk', self.gf('django.db.models.fields.related.ForeignKey')(related_name='player_history', to=orm['league.LeaguePlayerMap'])),
        ))
        db.send_create_signal(u'league', ['PositionHistory'])


    def backwards(self, orm):
        # Deleting model 'PositionHistory'
        db.delete_table(u'league_positionhistory')
    ...
    models = {
        ...
        u'league.positionhistory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'league_player_fk': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'player_history'", 'to': u"orm['league.LeaguePlayerMap']"}),
