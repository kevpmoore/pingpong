...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PositionHistory.position'
        db.delete_column(u'league_positionhistory', 'position')

        # Adding field 'PositionHistory.rating'
        db.add_column(u'league_positionhistory', 'rating',
                      self.gf('django.db.models.fields.FloatField')(default=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PositionHistory.position'
        db.add_column(u'league_positionhistory', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=1000),
                      keep_default=False)

        # Deleting field 'PositionHistory.rating'
        db.delete_column(u'league_positionhistory', 'rating')
