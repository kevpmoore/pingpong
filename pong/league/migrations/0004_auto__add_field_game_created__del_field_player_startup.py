...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'league_game', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 1, 2, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Player.startup'
        db.delete_column(u'league_player', 'startup')


    def backwards(self, orm):
        # Deleting field 'Game.created'
        db.delete_column(u'league_game', 'created')

        # Adding field 'Player.startup'
        db.add_column(u'league_player', 'startup',
